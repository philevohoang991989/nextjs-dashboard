      ...
      <Form {...form}>
        ...
        >
          ...
          <div className="flex justify-end items-center gap-[12px]">
            ...
            <Button
              className="text-[14px] bg-white hover:bg-white text-[#0d6999] font-semibold shadow-none border-[1px] border-[#d0d5dd]"
              onClick={() =>
                router.push(`/browse/seminar/${seminar.idSeminar}/videos`)
              }
            >
              Add Video
            </Button>
